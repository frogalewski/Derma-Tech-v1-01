...
export async function* getFormulaSuggestionsStream(diseaseName: string, products: Product[] = [], language: Language = 'pt-BR'): AsyncGenerator<{ text?: string, sources?: GroundingSource[] }> {
    try {
